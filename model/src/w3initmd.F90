...
# ifdef W3_MFIT
      IF ( FLGRDALL(10, NOEXTR+1) ) NRQMAX = NRQMAX + NOXSM
# endif
# ifdef W3_STVP
      !
...
# endif
        ...
        END DO
# ifdef W3_MFIT
        IF ( FLGRDALL(10, NOEXTR+1) ) THEN
          DO I=1, NOXSM
            IH     = IH + 1
            IT     = IT + 1
            CALL MPI_SEND_INIT (XSMH(1,I),NSEALM , MPI_REAL, IROOT,  &
                 IT, MPI_COMM_WAVE, IRQGO(IH), IERR)
#  ifdef W3_MPIT
            WRITE (STRING,'(A3,I2.2)') '10/', I
            WRITE (NDST,9011) IH, STRING, IROOT, IT, IRQGO(IH), IERR
...
# ifdef W3_MFIT
          IF ( FLGRDALL(10, NOEXTR+1) ) THEN
            DO I=1, NOXSM
              IH     = IH + 1
              IT     = IT + 1
              CALL MPI_RECV_INIT (XSMH(I0,I),1,WW3_FIELD_VEC, IFROM, IT, &
                         MPI_COMM_WAVE, IRQGO2(IH), IERR )
#  ifdef W3_MPIT
              WRITE (STRING,'(A3,I2.2)') '10/', I
              WRITE (NDST,9011) IH, STRING, IFROM, IT, IRQGO2(IH), IERR
